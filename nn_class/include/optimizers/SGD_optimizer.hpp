...
class SGD_optimizer : public Optimizer
{
    ...
    bool update_weights;
public:
    SGD_optimizer(int a_batch_size=1, float a_learning_rate=0.1, float a_lr_reduction_coef=1, float a_regularization_coef=0, float a_min_lr=1e-7, float a_max_lr=5e-1,OCLW *a_oclw=0);
